...
class CustomCeoInfoAdmin(SortableAdminMixin, TranslationAdmin):
    fieldsets = (
    ...
    list_display = ('name', 'post', 'sort_order',)
...
class CeoDatasAdmin(CustomCeoInfoAdmin):
    pass
    # Можно добавить дополнительные настройки админки, если нужно